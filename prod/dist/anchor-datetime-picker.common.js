...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_sass___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("1252");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_sass___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_sass___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_node_modules_vuetify_loader_lib_loader_js_ref_18_0_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_app_vue_vue_type_style_index_0_lang_sass___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"d844324e-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vuetify-loader/lib/loader.js??ref--18-0!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/app.vue?vue&type=template&id=5a06ea2d&
var appvue_type_template_id_5a06ea2d_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-card',{attrs:{"anchor-datetime-picker-container":""}},[_c('v-card-text',{staticClass:"px-0 py-0"},[_c('div',[_vm._v("focusTab: "+_vm._s(_vm.focusTab))]),_c('div',[_vm._v("result: "+_vm._s(_vm.result))]),_c('v-tabs',{attrs:{"fixed-tabs":""},model:{value:(_vm.focusTab),callback:function ($$v) {_vm.focusTab=$$v},expression:"focusTab"}},[(_vm.hasDate)?_c('v-tab',[_vm._t("dateIcon",[_c('v-icon',[_vm._v("fa fa-calendar")])])],2):_vm._e(),(_vm.hasTime)?_c('v-tab',[_vm._t("timeIcon",[_c('v-icon',[_vm._v("fa fa-clock")])])],2):_vm._e(),_c('v-tabs-items',{model:{value:(_vm.focusTab),callback:function ($$v) {_vm.focusTab=$$v},expression:"focusTab"}},[(_vm.hasDate)?_c('v-tab-item',[_c('v-date-picker',_vm._b({attrs:{"full-width":"","locale":_vm.locale},on:{"input":_vm.focusTimePicker},model:{value:(_vm.date),callback:function ($$v) {_vm.date=$$v},expression:"date"}},'v-date-picker',_vm.datePickerProps,false))],1):_vm._e(),(_vm.hasTime)?_c('v-tab-item',[_c('v-time-picker',_vm._b({attrs:{"full-width":"","use-seconds":"","locale":_vm.locale},model:{value:(_vm.time),callback:function ($$v) {_vm.time=$$v},expression:"time"}},'v-time-picker',_vm.timePickerProps,false))],1):_vm._e()],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/app.vue?vue&type=template&id=5a06ea2d&
...
/* harmony default export */ var appvue_type_script_lang_babel_ = ({
  ...
  computed: {
    ...
    isDatetime() {
      if(this.hasDate == true && this.hasTime == true) return true
      return false
    },
    hasDate() {
      return true
    ...
    formattedDate() {
      ...
      return moment_default()(this.date).format(this.dateFormat)
    },
    formattedTime() {
      if(!this.time) return null
      const today = moment_default()().format('YYYY-MM-DD')
      return moment_default()(`${today} ${this.time}`).format(this.timeFormat)
    },
    result() {
      console.warn(this.formattedDate, this.formattedTime)
      return null
    },
  },
});
...
// EXTERNAL MODULE: ./src/components/app.vue?vue&type=style&index=0&lang=sass&
var appvue_type_style_index_0_lang_sass_ = __webpack_require__("36da");
...
function VPicker_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { VPicker_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { VPicker_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var component = normalizeComponent(
  ...
  appvue_type_template_id_5a06ea2d_render,
  staticRenderFns,
  false,
  null,
  null,
